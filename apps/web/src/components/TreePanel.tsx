...
const KIND_DISPLAY: Record<string, string> = {
  ...
  floor: 'Floor', Floor: 'Floor', level: 'Floor', Level: 'Floor',
  room: 'Room', Room: 'Room', space: 'Room', Space: 'Room',
  device: 'Device', Device: 'Device', equipment: 'Device',
  equipmentext: 'Device', EquipmentExt: 'Device',
  point: 'Point', Point: 'Point', pointext: 'Point', PointExt: 'Point',
};
...
function TreeNodeItem({ node, depth, selectedId, onSelect, expanded, setExpanded, errorIds, search }: TreeNodeProps) {
    ...
    <>
      ...
      >
        <span
          ...
          aria-hidden="true"
        >▶</span>
        <span className={`kind-pill kind-${displayKind}`}>
          {displayKind.slice(0, 4)}
        </span>
