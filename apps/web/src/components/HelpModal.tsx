    ...
    body = (
      <dl style={{ margin: 0 }}>
        <div className="glossary-term">
          <dt>Site</dt>
          <dd>敷地・拠点。最上位の単位。例：本社キャンパス、品川データセンター。</dd>
        </div>
        <div className="glossary-term">
          <dt>Building</dt>
          <dd>建物。1つのサイト内に複数あり得ます。</dd>
        </div>
        <div className="glossary-term">
          <dt>Floor / Level</dt>
          <dd>階層。例：1F、B1、屋上。</dd>
        ...
        <div className="glossary-term">
          <dt>Room / Space</dt>
          <dd>部屋・ゾーン。設置エリアの単位。</dd>
        </div>
        <div className="glossary-term">
          <dt>Device</dt>
          <dd>機器。エアコン、照明、センサー、メーター等。</dd>
        </div>
        <div className="glossary-term">
          <dt>Point</dt>
          <dd>計測点／制御点。1機器が複数のポイントを持ちます（例：室温、設定温度、運転状態）。</dd>
        </div>
        <div className="glossary-term">
          <dt>pointType</dt>
          <dd>
        ...
        <div className="glossary-term">
          <dt>writable</dt>
          <dd>制御可能か。true=書込可、false=読取専用。</dd>
        </div>
        <div className="glossary-term">
          <dt>デバイステンプレート</dt>
          <dd>同じデバイス種別が共通で持つべきプロパティ群の定義。CSVから自動推定できます。</dd>
        </div>
        <div className="glossary-term">
          <dt>SHACL</dt>
          <dd>RDFデータの制約検証言語。出力時の整合性チェックに使われます。</dd>
        </div>
        <div className="glossary-term">
          <dt>JSON-LD</dt>
          <dd>Linked Data形式のJSON。Brick等のセマンティックモデルと連携可能。</dd>
        </div>
        <div className="glossary-term">
          <dt>RDF Turtle</dt>
          <dd>セマンティックWeb形式のRDF表現。SPARQLで問い合わせができます。</dd>
        </div>
      </dl>
    );
  }
